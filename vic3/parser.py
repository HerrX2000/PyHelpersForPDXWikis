    ...
    def _parse_building_group(self, parsed_building_groups: dict[str, BuildingGroup], data, name: str) -> BuildingGroup:
        ...
        for k, v in data:
            if k in ['category', 'always_possible', 'economy_of_scale', 'is_subsistence',
                     ...
                     'min_productivity_to_hire', 'owns_other_buildings', 'always_self_owning' , 'has_trade_revenue' , 'company_headquarter' , 'regional_company_headquarter', 'construction_efficiency_modifier']:
                entity_values[k] = v
            elif k == 'parent_group':
